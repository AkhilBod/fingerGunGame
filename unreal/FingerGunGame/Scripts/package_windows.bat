...
call "%UE%\Engine\Build\BatchFiles\RunUAT.bat" BuildCookRun -project="%~dp0..\FingerGunGame.uproject" -noP4 -platform=Win64 -clientconfig=Development -build -cook -stage -pak -archive -archivedirectory="%~dp0..\Packaged" -map=/Game/Levels/IronHorse -utf8output
echo.
